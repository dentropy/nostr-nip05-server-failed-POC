let mah_elements = {
  "nodes": [
    ...
    {
      "data": {
        "id": "key_value_pattern__change_log_index_*",
        "dd_index": "root",
        "type": "key_value_patterns",
        "pattern": "change_log_index_*",
        "display_name": "root"
      }
    },
    {
  ...
  "edges": [
    ...
    {
      "data": {
        "id": "dd_index__root__TO__key_value_pattern__change_log_index_*",
        "source": "dd_index__root",
        "target": "key_value_pattern__change_log_index_*",
        "type": "index_to_kvp"
      }
    },
    {
      "data": {
        "id": "dd_index__root__TO__key_value_pattern__change_log_count",
        "source": "dd_index__root",
